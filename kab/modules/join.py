...
from kab import app, ASSUSERNAME
from kab.utils.decorators import sudo_users_only, errors
...
async def rem(USER, message):
    ...
    try:
        ...
        await message.reply_text(
            "❌ __**Kutty Angel's Assistant can't leave your group! probably waiting for floodwaits**__\n\n» Manually remove me from your group</b>"
        )
...
async def bye(client, message):
    left = 0
    sleep_time = 0.1
    lol = await message.reply("**Kutty Angel's Assistant leaving all groups**\n\n`Processing...`")
    async for dialog in USER.iter_dialogs():
        try:
            ...
            pass
    await lol.edit(f"🏃‍♂️ `Kutty Angel's Assistant leaving...`\n\n» **Left:** {left} chats.")
