...
from kab.tgcalls import calls, queues
from kab.tgcalls.youtube import download
from kab.tgcalls import convert as cconvert
from kab.tgcalls.calls import client as ASS_ACC
from kab.database.queue import (
    get_active_chats,
    is_active_chat,
    add_active_chat,
    remove_active_chat,
...
from kab import BOT_NAME, BOT_USERNAME
from kab import app
import kab.tgcalls
from kab.tgcalls import youtube
...
from kab.utils.filters import command
from kab.utils.decorators import errors, sudo_users_only
from kab.utils.administrator import adminsOnly
from kab.utils.errors import DurationLimitError
from kab.utils.gets import get_url, get_file_name
from kab.modules.admins import member_permissions
...
async def speed(_, query: CallbackQuery):
    await query.answer(
            "🌟 KUTTY ANGEL'S SPEED OF THE SERVER :\n• 4.4568 ms\n• 1264.0 ms\n• 98.20 ms\n• 00.01 ms",
            show_alert=True,
        )
